...
describe("PhotoPicker", () => {
  ...
  test("a denied permission explains itself without a live region and offers Settings", async () => {
  ...
  test("a launcher that fails explains itself without offering Settings", async () => {
