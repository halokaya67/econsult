...
- **Location:** `specs/001-econsult-flow/how-it-works.md:86` (also :87; `spec.md:146`)
...
- **Severity:** WARNING
- **Category:** ambiguity
- **Location:** `specs/001-econsult-flow/spec.md:105` (also :44, :125, :131-135, :139)
...
- **Severity:** INFO
- **Category:** coverage
- **Location:** `specs/001-econsult-flow/spec.md:127` (also :44, :186)
